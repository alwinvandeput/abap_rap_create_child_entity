CLASS zrgd_data_source_ett DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zrgd_data_source_ett IMPLEMENTATION.

  METHOD if_rap_query_provider~select.

    CONSTANTS max_line_count TYPE i VALUE 50.

    DATA business_data TYPE TABLE OF ZI_RgdDataSource .
    DATA business_data_line TYPE ZI_RgdDataSource .
...
*            DATA(data_source_type) = zdmo_cl_rap_node=>data_source_types-table.
          ...
          WHEN 'ZI_RGDDATASOURCE'.
            DATA(data_source_type) = zdmo_cl_rap_node=>data_source_types-cds_view.
        ...
        IF search_string IS NOT INITIAL.
          ...
          CASE  data_source_type.
            ...
            WHEN ZDMO_cl_rap_node=>data_source_types-cds_view.
              ...
              DATA(lt_cds_views) = xco_lib->get_views( VALUE #(
                ( lo_name_filter ) ) ).
...
*
        ...
        CASE data_source_type.
          WHEN ZDMO_cl_rap_node=>data_source_types-cds_view OR
               ZDMO_cl_rap_node=>data_source_types-abstract_entity .
...
*                business_data_line-is_root_node = is_root_node.
*                business_data_line-parent_data_source = parent_data_source.
*               business_data_line-parent_data_source = ls_cds_view-NAME.
...
*              ENDIF.
            ...
            SORT business_data BY name.
            DATA lv_counter TYPE i.
            LOOP AT business_data INTO DATA(ls_business).

              lv_counter += 1.

              IF lv_counter <= skip.
                DELETE business_data INDEX sy-tabix.
              ENDIF.
              IF lv_counter > top.
                DELETE business_data INDEX sy-tabix.
              ENDIF.
